...
void get_data (struct Module modules[], int lines);
int parse_file (char before[], char after[], char *buff);
void print_html (struct Module modules[], int qnty);

int main (int argc, char *argv[])
{

  printf ("Content-Type: text/html\n\n");
  /*Cuento modulos instalados*/
  int lines = count_installed_modules ();
  ...
  /*Creo estructura del tamano de modulos contados (i.e, obtengo el total de modulos en sistema)*/
  struct Module modules[lines];

  /*Obtengo datos de dichos modulos*/
  get_data (modules, lines);

  print_html(modules, lines);
